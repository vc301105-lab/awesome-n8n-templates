...
| AI YouTube Shorts Studio Pro v2 (Gemini Omni 1.1 Flash and Veo) | Dual-engine AI video pipeline: Gemini 2.5 Pro (free) plans the scenes, then a Config switch generates 9:16 footage with either Gemini Omni 1.1 Flash (Interactions API, default) or Veo 3.1 (predictLongRunning) — both with submit/poll loops, per-scene Pexels fallback, free Hindi neural voiceover with auto-synced boxed captions, branded outro and private YouTube upload. | Marketing/Content Creation/AI | [Link to Template](Instagram_Twitter_Social_Media/AI%20YouTube%20Shorts%20Studio%20Pro%20v2%20(Gemini%20Omni%201.1%20Flash%20and%20Veo).json) |
