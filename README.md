...
Explore 19 social media automation templates for n8n covering Instagram, Twitter/X, Reddit, YouTube, LinkedIn, and more. Templates include AI-powered Instagram DM management with Manychat, dynamic Twitter banners, trend-based content generation with AI image creation, tweet generators, YouTube-to-X posting, Reddit digest creation, social media analytics, virtual AI influencer management, and end-to-end AI YouTube video generation.
...
| Free AI YouTube Shorts Generator Professional Edition (Gemini Pro, Pexels and JSON2Video) | Fully free professional pipeline (no credit card): Gemini 2.5 Pro writes the scene-by-scene script, SEO title, description and tags, Pexels sources vertical cinematic stock footage, and JSON2Video renders a 1080x1920 Short with Hindi neural voiceover, auto-synced boxed captions, golden hook titles, fade transitions and a branded FOLLOW outro before uploading privately to YouTube. | Marketing/Content Creation/AI | [Link to Template](Instagram_Twitter_Social_Media/Free%20AI%20YouTube%20Shorts%20Generator%20Professional%20Edition%20(Gemini%20Pro%2C%20Pexels%20and%20JSON2Video).json) |
| AI YouTube Shorts Studio Pro with Google Veo (Hybrid Free Stack) | Hybrid pipeline where only video generation is paid: Gemini 2.5 Pro (free) plans the scenes, Google Veo 3.1 generates cinematic 9:16 footage per scene with submit/poll loops, any failed Veo scene automatically falls back to free Pexels stock, and JSON2Video (free) assembles everything with Hindi voiceover, boxed captions and a branded outro before a private YouTube upload. | Marketing/Content Creation/AI | [Link to Template](Instagram_Twitter_Social_Media/AI%20YouTube%20Shorts%20Studio%20Pro%20with%20Google%20Veo%20(Hybrid%20Free%20Stack).json) |
| Professional AI YouTube Shorts Studio (Full Google Pro Stack) | Premium all-Google pipeline (requires pay-as-you-go Gemini API billing): Gemini 2.5 Pro plans the script scene-by-scene, Gemini Pro TTS narrates, Veo 3.1 generates cinematic 9:16 footage per scene, Nano Banana Pro designs the branded outro, and JSON2Video assembles everything with karaoke captions into a 1080x1920 Short that is uploaded privately to YouTube. | Marketing/Content Creation/AI | [Link to Template](Instagram_Twitter_Social_Media/Professional%20AI%20YouTube%20Shorts%20Studio%20(Full%20Google%20Pro%20Stack).json) |
| End-to-End AI YouTube Video Generator | Turns a single topic into a finished YouTube Short: Gemini writes the script and metadata, ElevenLabs generates a Hindi/Hinglish voiceover, Creatomate renders the video with the caption and audio, and the result is uploaded privately to YouTube. | Marketing/Content Creation/AI | [Link to Template](Instagram_Twitter_Social_Media/End-to-End%20AI%20YouTube%20Video%20Generator.json) |
